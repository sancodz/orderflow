...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Handle JWT exceptions (e.g., expired, malformed) - response can be customized here
            logger.warn("JWT token processing error: " + e.getMessage());
            // For now, just let it pass to be handled by subsequent security mechanisms
            // or to result in an unauthenticated state.
        }
        filterChain.doFilter(request, response);
    }
}